...
[![Stars](https://img.shields.io/github/stars/bashairfan0911/retail-store-sample-app)](Stars)
...
```sh
git clone https://github.com/bashairfan0911/retail-store-sample-app.git
```
